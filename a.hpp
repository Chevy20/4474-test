                ...
                <h2>Details</h2><hr>
                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <a class="btn btn-primary " data-bs-toggle="popover" data-bs-placement="top" title="Edit information" href="changepassword.php"  >Edit Information</a>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <?php
                            $result1 = $connection -> query('SELECT Prov, Country, Account_info.Postal FROM Account_info, User_info WHERE Account_info.user_id = ' . $user_id . ' and Account_info.Postal = User_info.Postal');
                            ...
                            echo '<br><br>';
                            echo '<span> Postal Code: &nbsp;' . $row1["Account_info.Postal"] . '</span>';
                            echo '<br><br>';
                          ?>
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingOne">
                        ...
                        <i class="fa-regular fa-credit-card fa-xl" style="color: #ffdd00;"></i>
